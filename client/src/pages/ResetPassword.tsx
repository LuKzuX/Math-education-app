      ...
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          <div className="inline-flex items-center justify-center w-12 h-12 rounded-xl bg-cyan-400/10 border border-cyan-400/30 mb-4">
            <FaLock className="w-6 h-6 text-cyan-400" />
          </div>
        ...
        {message ? (
          <div className="rounded-xl border border-emerald-800/60 bg-emerald-950/30 px-6 py-8 text-center">
            ...
            <button
              ...
              className="font-data text-[12px] tracking-widest uppercase text-cyan-400 border border-cyan-400/40 rounded-lg px-4 py-2.5 hover:bg-cyan-400/10 transition-colors"
            >
              Go to sign in
            </button>
          </div>
